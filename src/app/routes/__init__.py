...
@base.router.get("/about")
def about(request: Request):
    """About page - some background information about this app."""
    return base.templates.TemplateResponse("about.html", {"request": request})


@base.router.get("/catalog")
